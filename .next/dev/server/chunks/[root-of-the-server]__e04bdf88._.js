...
async function DELETE(request, { params } // Fix here too
) {
    try {
        // Await the params
...
async function PUT(request, { params } // Fix here too
) {
    try {
        const { id } = await params;
    ...
    `;
      ...
      RETURNING *
    `;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedStudent);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e04bdf88._.js.map