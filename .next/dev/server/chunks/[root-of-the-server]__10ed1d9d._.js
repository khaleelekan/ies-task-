...
async function DELETE(request, { params } // params is now a Promise
) {
    try {
...
async function GET(request, { params }) {
    ...
    `;
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(classItem);
    } catch (error) {
...
async function PUT(request, { params }) {
    ...
    `;
      ...
      RETURNING *
    `;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedClass);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__10ed1d9d._.js.map